...
exports.MantaPrivateWallet = exports.Network = exports.Environment = void 0;
var api_1 = require("@polkadot/api");
var util_crypto_1 = require("@polkadot/util-crypto");
// @ts-ignore
var index_1 = __importStar(require("./api/index"));
var bn_js_1 = __importDefault(require("bn.js"));
var manta_config_json_1 = __importDefault(require("./manta-config.json"));
var utils_1 = require("./utils");
var rpc = manta_config_json_1.default.RPC;
var types = manta_config_json_1.default.TYPES;
var DEFAULT_PULL_SIZE = manta_config_json_1.default.DEFAULT_PULL_SIZE;
var SIGNER_URL = manta_config_json_1.default.SIGNER_URL;
...
var MantaPrivateWallet = /** @class */ (function () {
    ...
    MantaPrivateWallet.prototype.convertPrivateAddressToJson = function (address) {
        var bytes = (0, util_crypto_1.base58Decode)(address);
    ...
    MantaPrivateWallet.prototype.getNetworks = function () {
        return manta_config_json_1.default.NETWORKS;
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        privateAddress = (0, util_crypto_1.base58Encode)(privateAddressBytes);
                        this.walletIsBusy = false;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        balance = new bn_js_1.default(balanceString);
                        this.walletIsBusy = false;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.network === Network.Dolphin && assetId.toString() === utils_1.NATIVE_TOKEN_ASSET_ID) {
    ...
    MantaPrivateWallet.initApi = function (env, network, loggingEnabled) {
        var _this = this;
        var provider = new api_1.WsProvider(MantaPrivateWallet.envUrl(env, network));
        var api = new api_1.ApiPromise({ provider: provider, types: types, rpc: rpc });
        if (loggingEnabled) {
    ...
    MantaPrivateWallet.initWasmSdk = function (api, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('./wallet/crate/pkg/manta_wasm_wallet')); })];
                    case 1:
                        wasm = _c.sent();
                        wasmSigner = new wasm.Signer(SIGNER_URL);
                        wasmApiConfig = new index_1.ApiConfig(((_a = config.maxReceiversPullSize) !== null && _a !== void 0 ? _a : DEFAULT_PULL_SIZE), ((_b = config.maxSendersPullSize) !== null && _b !== void 0 ? _b : DEFAULT_PULL_SIZE), config.pullCallback, config.errorCallback, Boolean(config.loggingEnabled));
                        wasmApi = new index_1.default(api, wasmApiConfig);
    ...
    MantaPrivateWallet.envUrl = function (env, network) {
        var url = manta_config_json_1.default.NETWORKS[network].ws_local;
        if (env == Environment.Production) {
            url = manta_config_json_1.default.NETWORKS[network].ws;
        }
        return url;
    };
    ...
    MantaPrivateWallet.prototype.convertReceiverPost = function (x) {
        ...
        x.utxo.public_asset.value = new bn_js_1.default(x.utxo.public_asset.value).toArray('le', 16);
...
exports.MantaPrivateWallet = MantaPrivateWallet;
