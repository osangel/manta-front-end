...
module.exports.AssetMetadata = AssetMetadata;
/**
*/
class ControlFlow {
...
module.exports.LedgerError = LedgerError;
/**
*/
class Network {
...
module.exports.PolkadotJsLedger = PolkadotJsLedger;
/**
*/
class ReceiverPost {
...
module.exports.ReceiverPost = ReceiverPost;
/**
*/
class SenderPost {
...
module.exports.SenderPost = SenderPost;
/**
* Signer Client
*/
class Signer {
...
module.exports.SignerError = SignerError;
/**
*/
class Transaction {
...
module.exports.TransactionKind = TransactionKind;
/**
* Transfer Post
*/
class TransferPost {
...
module.exports.TransferPost = TransferPost;
/**
...
module.exports.__wbg_asset_new = function(arg0) {
    const ret = Asset.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_pull_dbd9dd698c1a64a2 = function(arg0, arg1) {
    const ret = getObject(arg0).pull(takeObject(arg1));
    return addHeapObject(ret);
};

module.exports.__wbg_push_1da70c715d0a0168 = function(arg0, arg1, arg2) {
...
module.exports.__wbindgen_closure_wrapper930 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 275, __wbg_adapter_28);
    return addHeapObject(ret);
};

const path = require('path').join(__dirname, 'manta_wasm_wallet_bg.wasm');
