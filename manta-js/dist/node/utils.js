...
exports.MantaUtilities = exports.NATIVE_TOKEN_ASSET_ID = void 0;
...
exports.NATIVE_TOKEN_ASSET_ID = '1';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(manta_config_json_1.default.SIGNER_URL, "version"), {
                                timeout: 1500
                            })];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        if (!(assetId.toString() === exports.NATIVE_TOKEN_ASSET_ID)) return [3 /*break*/, 2];
                        return [4 /*yield*/, api.query.system.account(address)];
                    case 1:
                        nativeBalance = _a.sent();
                        return [2 /*return*/, new bn_js_1.default(nativeBalance.data.free.toString())];
                    ...
                    case 3:
                        ...
                        if (assetBalance.value.isEmpty) {
                            ...
                            return [2 /*return*/, new bn_js_1.default(assetBalance.value.balance.toString())];
                        }
                        _a.label = 4;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        assetIdArray = Array.from(privateWallet_1.MantaPrivateWallet.assetIdToUInt8Array(assetId));
...
exports.MantaUtilities = MantaUtilities;
